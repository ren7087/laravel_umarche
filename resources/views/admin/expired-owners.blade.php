                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <form method="post" id="delete_{{ $owner->id }} action='{{ route('admin.expired-owners.destroy', ['owner' => $owner->id]) }}'">
                                    @csrf
                                    <td class="px-4 py-3">
                                        <a href="#" data-id="{{ $owner->id }}" onclick="deletePost(this)" class="text-white bg-indigo-500 border-0 py-2 px-4 focus:outline-none hover:bg-imdigo-600 rounded">完全に削除</a>
                                    </td>
                                  </form>
                                </tr>
                                @endforeach
